...
public class FastMath {
    ...
    public static void main(String[] a) {
        ...
        com.hackoeur.jglm.support.FastMathCalc.printarray(out, "EXP_INT_TABLE_A", EXP_INT_TABLE_LEN, ExpIntTable.EXP_INT_TABLE_A);
        com.hackoeur.jglm.support.FastMathCalc.printarray(out, "EXP_INT_TABLE_B", EXP_INT_TABLE_LEN, ExpIntTable.EXP_INT_TABLE_B);
        com.hackoeur.jglm.support.FastMathCalc.printarray(out, "EXP_FRAC_TABLE_A", EXP_FRAC_TABLE_LEN, ExpFracTable.EXP_FRAC_TABLE_A);
        com.hackoeur.jglm.support.FastMathCalc.printarray(out, "EXP_FRAC_TABLE_B", EXP_FRAC_TABLE_LEN, ExpFracTable.EXP_FRAC_TABLE_B);
        com.hackoeur.jglm.support.FastMathCalc.printarray(out, "LN_MANT", LN_MANT_LEN, lnMant.LN_MANT);
        com.hackoeur.jglm.support.FastMathCalc.printarray(out, "SINE_TABLE_A", SINE_TABLE_LEN, SINE_TABLE_A);
        com.hackoeur.jglm.support.FastMathCalc.printarray(out, "SINE_TABLE_B", SINE_TABLE_LEN, SINE_TABLE_B);
        com.hackoeur.jglm.support.FastMathCalc.printarray(out, "COSINE_TABLE_A", SINE_TABLE_LEN, COSINE_TABLE_A);
        com.hackoeur.jglm.support.FastMathCalc.printarray(out, "COSINE_TABLE_B", SINE_TABLE_LEN, COSINE_TABLE_B);
        com.hackoeur.jglm.support.FastMathCalc.printarray(out, "TANGENT_TABLE_A", SINE_TABLE_LEN, TANGENT_TABLE_A);
        com.hackoeur.jglm.support.FastMathCalc.printarray(out, "TANGENT_TABLE_B", SINE_TABLE_LEN, TANGENT_TABLE_B);
    }
        ...
        static {
            if (RECOMPUTE_TABLES_AT_RUNTIME) {
                ...
                for (int i = 0; i < FastMath.EXP_INT_TABLE_MAX_INDEX; i++) {
                    com.hackoeur.jglm.support.FastMathCalc.expint(i, tmp);
                    EXP_INT_TABLE_A[i + FastMath.EXP_INT_TABLE_MAX_INDEX] = tmp[0];
                    EXP_INT_TABLE_B[i + FastMath.EXP_INT_TABLE_MAX_INDEX] = tmp[1];

                    if (i != 0) {
                        // Negative integer powers
                        com.hackoeur.jglm.support.FastMathCalc.splitReciprocal(tmp, recip);
                        EXP_INT_TABLE_A[FastMath.EXP_INT_TABLE_MAX_INDEX - i] = recip[0];
                        EXP_INT_TABLE_B[FastMath.EXP_INT_TABLE_MAX_INDEX - i] = recip[1];
                    }
                }
            } else {
                EXP_INT_TABLE_A = com.hackoeur.jglm.support.FastMathLiteralArrays.loadExpIntA();
                EXP_INT_TABLE_B = com.hackoeur.jglm.support.FastMathLiteralArrays.loadExpIntB();
            }
        }
    }
        ...
        static {
            if (RECOMPUTE_TABLES_AT_RUNTIME) {
                ...
                for (int i = 0; i < EXP_FRAC_TABLE_A.length; i++) {
                    com.hackoeur.jglm.support.FastMathCalc.slowexp(i * factor, tmp);
                    EXP_FRAC_TABLE_A[i] = tmp[0];
                    EXP_FRAC_TABLE_B[i] = tmp[1];
                }
            } else {
                EXP_FRAC_TABLE_A = com.hackoeur.jglm.support.FastMathLiteralArrays.loadExpFracA();
                EXP_FRAC_TABLE_B = com.hackoeur.jglm.support.FastMathLiteralArrays.loadExpFracB();
            }
        }
    }
        ...
        static {
            if (RECOMPUTE_TABLES_AT_RUNTIME) {
                ...
                for (int i = 0; i < LN_MANT.length; i++) {
                    ...
                    LN_MANT[i] = com.hackoeur.jglm.support.FastMathCalc.slowLog(d);
                }
            } else {
                LN_MANT = com.hackoeur.jglm.support.FastMathLiteralArrays.loadLnMant();
            }
        }
    }
